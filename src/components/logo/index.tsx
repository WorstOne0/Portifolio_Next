...
export default function Logo() {
  return (
    <div className="h-full w-full bg-[var(--background-dark)] flex flex-col justify-center items-center gap-[2rem]">
      {/* Rocket */}
      <motion.div
      ...
      {/* Name — fades first */}
      <motion.span
        className="text-white/90 text-[2.2rem] font-light italic tracking-[0.15rem]"
        animate={{ opacity: 0 }}
      ...
      <motion.span
        className="text-white/75 text-[1.4rem] font-bold tracking-[0.35rem] mt-[-0.4rem]"
        animate={{ opacity: 0 }}
